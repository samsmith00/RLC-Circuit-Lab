...
class Critically_Damped(Scene): 
    ...
    def construct(self):
        ...
        vector_field = ArrowVectorField(vector_field_func, x_range=[-10, 10, 0.5], y_range=[-10, 10, 0.5])
        stream_lines = StreamLines(vector_field_func,  x_range = [-10, 10, 0.5], y_range = [-10, 10, 0.5])
        stream_lines.set_color_by_gradient(YELLOW, GREEN, BLUE)
